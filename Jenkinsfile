            ...
            steps { 
                ...
                secretKeyVariable: 'AWS_SECRET_ACCESS_KEY']]){
                    script {
                        ...
                        sh "docker run -d -p 49160:8080 ${env.ecr_url}:${env.git_branch} --log-driver=awslogs --log-opt awslogs-group=MainAcademy_container_logs --log-opt awslogs-region=eu-central-1 --log-opt awslogs-stream=my-container-stream"
